...
parsed as (
    select
        ...
        -- verbatim raw (full situs string, noise and all)
        situs_full                                             as raw_address,

        -- normalized full street (number + name; abbreviations expanded, unit stripped)
        ...
        -- leading house number split out of the combined line
...
filtered as (
    -- need at least a street OR a city+state to be matchable
    select *
    from parsed
