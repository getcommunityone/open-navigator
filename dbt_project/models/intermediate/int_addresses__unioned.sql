...
/*
    ...
    Sources wired so far (address pipeline, strongest geo signal first):
      - stg_parcels__address    (bronze_addresses, ~598k parcel records)
      - stg_locations__address  (bronze_locations / HIFLD facilities)

    TODO: add stg_nccs__address, stg_event_place__address as those conform.
*/
...
select
    -- surrogate key for the occurrence (stable across runs)
