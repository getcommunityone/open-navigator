-- Canonical copy: scripts/discovery/sql/bronze_jurisdictions_scraped.sql
-- (keep in sync when editing DDL — discovery pipeline reads the same file under scripts/discovery/sql/)
--
