...
Examples::
    ...
    python packages/scrapers/src/scrapers/youtube/download_tuscaloosa_city_meeting_audio.py

    # List matches without downloading
    python packages/scrapers/src/scrapers/youtube/download_tuscaloosa_city_meeting_audio.py --dry-run

    # Catalog only (Postgres bronze rows, no yt-dlp audio)
    python packages/scrapers/src/scrapers/youtube/download_tuscaloosa_city_meeting_audio.py --catalog-only

    # Download only (rows already in bronze from a prior catalog pass)
    python packages/scrapers/src/scrapers/youtube/download_tuscaloosa_city_meeting_audio.py --download-only
"""
