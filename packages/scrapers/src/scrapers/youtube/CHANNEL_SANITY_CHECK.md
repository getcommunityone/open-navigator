...
python packages/scrapers/src/scrapers/youtube/analyze_channels.py

# Show potential junk channels
python packages/scrapers/src/scrapers/youtube/analyze_channels.py --show-junk

# Auto-flag junk channels
python packages/scrapers/src/scrapers/youtube/analyze_channels.py --flag-junk
```
