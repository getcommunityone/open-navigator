...
def transcript_failure_hint(message: str) -> Optional[str]:
    ...
    if "407" in lower or "proxy authentication required" in lower:
        return (
            ...
            ".venv/bin/python packages/scrapers/src/scrapers/youtube/verify_webshare_proxy.py"
        )
    if "proxyerror" in lower or (
        ...
        return (
            ...
            "or run: .venv/bin/python packages/scrapers/src/scrapers/youtube/verify_webshare_proxy.py"
        )
