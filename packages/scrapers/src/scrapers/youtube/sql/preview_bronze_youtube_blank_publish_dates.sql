-- Rows in bronze_event_youtube missing both calendar event_date and published_at.
...
--
-- psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f packages/scrapers/src/scrapers/youtube/sql/preview_bronze_youtube_blank_publish_dates.sql
