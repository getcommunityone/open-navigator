...
Usage:
    python packages/scrapers/src/scrapers/census/download_census_school_districts.py --year 2025
    python packages/scrapers/src/scrapers/census/download_census_school_districts.py --year 2025 --types unified elementary
    python packages/scrapers/src/scrapers/census/download_census_school_districts.py --year 2025 --extract
"""
import sys
...
Examples:
  Download all school district types for 2023:
    python packages/scrapers/src/scrapers/census/download_census_school_districts.py --year 2023

  Download unified districts only:
    python packages/scrapers/src/scrapers/census/download_census_school_districts.py --year 2023 --types unified

  Download and extract:
    python packages/scrapers/src/scrapers/census/download_census_school_districts.py --year 2023 --extract
