...
Usage:
    python packages/scrapers/src/scrapers/census/download_census_shapefiles.py --year 2023
    python packages/scrapers/src/scrapers/census/download_census_shapefiles.py --year 2023 --types states counties
    python packages/scrapers/src/scrapers/census/download_census_shapefiles.py --year 2023 --extract
"""
import sys
...
Examples:
  Download all shapefiles for 2023:
    python packages/scrapers/src/scrapers/census/download_shapefiles.py --year 2023
  
  Download only states and counties:
    python packages/scrapers/src/scrapers/census/download_shapefiles.py --year 2023 --types states counties
  
  Download and extract:
    python packages/scrapers/src/scrapers/census/download_shapefiles.py --year 2023 --extract
  
  Download ZCTA (ZIP codes) only:
    python packages/scrapers/src/scrapers/census/download_shapefiles.py --year 2023 --types zcta

  Download places (municipalities/cities/towns) only:
    python packages/scrapers/src/scrapers/census/download_shapefiles.py --year 2023 --types places
