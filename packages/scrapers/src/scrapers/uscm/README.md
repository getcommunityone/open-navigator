...
- `scrape_mayor_elections.py` — **archived** (`archive/datasources/uscm/`): wrote mayor data to the dropped `civic_jurisdiction` columns (`current_mayor`, …) post migration 048. Use the Meet the Mayors → bronze path below instead.
