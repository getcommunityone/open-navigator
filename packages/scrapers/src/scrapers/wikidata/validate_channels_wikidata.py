...
Uses existing jurisdictions from public.civic_jurisdiction and validates
their YouTube channels against WikiData. Updates intermediate.int_events_channels_registry with
in_wikidata flags.
...
Usage:
    python packages/scrapers/src/scrapers/wikidata/validate_channels_wikidata.py --states AL,GA,IN,MA,MT,WA,WI
    
    python packages/scrapers/src/scrapers/wikidata/validate_channels_wikidata.py --states AL --limit 10
"""
import os
import sys
import argparse
