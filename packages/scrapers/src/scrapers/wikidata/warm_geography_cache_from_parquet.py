...
from scrapers.wikidata.geography_qid_cache import GeographyQidCache  # noqa: E402
from scrapers.wikidata.parquet_qid_lookup import (  # noqa: E402
...
def main() -> int:
    ...
    ap.add_argument("--postgres", action="store_true", help="Load parquet into bronze.bronze_jurisdiction_wikidata_fips_gnis_map table")
    ap.add_argument(
        "--apply-bronze",
        action="store_true",
    ...
    if args.postgres:
        ...
        logger.success(f"Loaded {n:,} rows into bronze.bronze_jurisdiction_wikidata_fips_gnis_map")
