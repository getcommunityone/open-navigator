...
Usage:
    ...
    python packages/scrapers/src/scrapers/youtube/load_channels.py --states AL,GA,IN,MA,MT,WA,WI
    
    # Load and validate
    python packages/scrapers/src/scrapers/youtube/load_channels.py --states AL,GA,IN,MA,MT,WA,WI --validate
    
    # Auto-flag junk channels
    python packages/scrapers/src/scrapers/youtube/load_channels.py --states AL,GA,IN,MA,MT,WA,WI --auto-flag
"""
import os
import sys
import json
