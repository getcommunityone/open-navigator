...
from ingestion.openstates.sync_elections_to_c1 import sync_jurisdiction_elections_to_c1
...
def _stable_id(prefix: str, key: str) -> str:
    from ingestion.openstates.sync_elections_to_c1 import make_ocd_id
