...
Run::
    ...
    .venv/bin/python -m scripts.datasources.openstates.sync_persons_to_c1 \\
        --states AL,GA,IN,MA,WA,WI
    .venv/bin/python -m scripts.datasources.openstates.sync_persons_to_c1 --all
    .venv/bin/python -m scripts.datasources.openstates.sync_persons_to_c1 --states MA --dry-run
"""
