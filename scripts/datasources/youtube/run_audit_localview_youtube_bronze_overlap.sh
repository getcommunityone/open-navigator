...
# Usage: ./scripts/datasources/youtube/run_audit_localview_youtube_bronze_overlap.sh GA
...
SQL="${ROOT}/scripts/datasources/youtube/audit_localview_youtube_bronze_overlap.sql"
