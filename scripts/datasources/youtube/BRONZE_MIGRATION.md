...
**File:** `scripts/datasources/youtube/load_youtube_channels_bronze.py`
...
### 8. Setup Script
**File:** `scripts/datasources/youtube/setup_channels_bronze.sh`
...
./scripts/datasources/youtube/setup_channels_bronze.sh
