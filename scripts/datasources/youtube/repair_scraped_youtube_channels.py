...
Usage (repo root):
  ...
  .venv/bin/python scripts/datasources/youtube/repair_scraped_youtube_channels.py --dry-run
  .venv/bin/python scripts/datasources/youtube/repair_scraped_youtube_channels.py --apply
  .venv/bin/python scripts/datasources/youtube/repair_scraped_youtube_channels.py --apply --states AL,GA
  .venv/bin/python scripts/datasources/youtube/repair_scraped_youtube_channels.py --apply --clear-only
"""
