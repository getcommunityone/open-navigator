...
For ``jurisdiction_id`` / richer joins to ``int_jurisdictions``, use dbt +:
  ...
  ``scripts/datasources/youtube/link_youtube_bronze_from_localview_apply.sql``

Examples::

  python scripts/datasources/youtube/sync_bronze_youtube_from_localview.py --dry-run
  python scripts/datasources/youtube/sync_bronze_youtube_from_localview.py --states AL,GA
"""
