...
--   ./scripts/datasources/youtube/run_audit_ga_youtube_download_filters.sh
--
-- Manual (must pass a full Postgres URL; empty DATABASE_URL makes psql use OS user on local socket):
--   psql "$NEON_DATABASE_URL_DEV" -v ON_ERROR_STOP=1 -f scripts/datasources/youtube/audit_ga_youtube_download_filters.sql
--
