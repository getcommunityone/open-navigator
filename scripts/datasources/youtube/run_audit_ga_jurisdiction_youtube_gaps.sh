...
FULL_SQL="${ROOT}/scripts/datasources/youtube/audit_ga_jurisdiction_youtube_gaps.sql"
MIN_SQL="${ROOT}/scripts/datasources/youtube/audit_ga_jurisdiction_youtube_gaps_minimal.sql"
