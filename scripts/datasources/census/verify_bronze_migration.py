...
def verify_bronze_database():
    ...
    if state_count == 0:
        ...
        logger.info("   Run: python scripts/datasources/census/load_census_states.py")
        return False
    elif state_count < 50:
...
def verify_deprecated_scripts():
    ...
    deprecated_files = [
        'scripts/datasources/census/link_cities_counties_to_search.py',
        'scripts/datasources/census/fix_geoid_format.py'
    ]
...
def verify_documentation():
    ...
    docs = [
        'scripts/datasources/census/MIGRATION_GUIDE.md',
        'scripts/datasources/census/README_BRONZE_MIGRATION.md'
    ]
