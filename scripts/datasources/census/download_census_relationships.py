...
Usage:
    python scripts/datasources/census/download_census_relationships.py
    python scripts/datasources/census/download_census_relationships.py --types zcta_county zcta_place
"""
import asyncio
...
async def download_all_relationships(
    ...
    logger.info("  1. Run: python scripts/datasources/census/load_census_relationships.py")
...
Examples:
  ...
  Download only ZCTA to county:
    python scripts/datasources/census/download_census_relationships.py --types zcta_county
  
  Force re-download all files:
    python scripts/datasources/census/download_census_relationships.py --force
