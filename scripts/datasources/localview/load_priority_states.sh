...
echo "  - web_docs/docs/guides/loading-meeting-data.md"
echo "  - web_docs/docs/integrations/localview.md"
echo "  - web_docs/docs/integrations/contacts-meetings-workflow.md"
echo ""
