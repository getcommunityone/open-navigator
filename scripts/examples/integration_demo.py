...
from scrapers.discovery.platform_detector import detect_platform_async, get_platform_capabilities
...
if __name__ == "__main__":
    ...
    print("🦷 CommunityOne Open Navigator - Platform Integration Demo")
    print("=" * 80)
