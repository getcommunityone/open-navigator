...
Run with:
    PGPASSWORD=password psql -h localhost -p 5433 -U postgres -d open_navigator -f packages/scrapers/src/scrapers/census/add_jurisdiction_columns_to_search.sql
*/
