...
# 1. Load states
python packages/scrapers/src/scrapers/census/load_census_states.py

# 2. Load municipalities
python packages/scrapers/src/scrapers/census/load_census_municipalities.py
...
### Loading Scripts
- `packages/scrapers/src/scrapers/census/load_census_states.py` - Load 52 states
- `packages/scrapers/src/scrapers/census/load_census_municipalities.py` - Load 19K+ cities
