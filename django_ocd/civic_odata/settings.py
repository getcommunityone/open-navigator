"""
Django settings for civic_odata project.
...
SECRET_KEY = 'django-insecure-mgs=u7w-q7*itpz)+nsnf9%vkyw%x+nknwo+rrw3cxrosqwus='
...
WSGI_APPLICATION = 'civic_odata.wsgi.application'
